              ...
              <div className="flex w-max animate-marquee hover:[animation-play-state:paused]">
                {[...skills, ...skills].map((skill, index) => (
                  <div
                    ...
                    className="group/item relative mx-4 flex w-36 flex-col items-center justify-start text-center transition-all duration-500 ease-geist h-24 hover:h-48 hover:scale-125"
                  >
