...
const skills = [
  ...
  { name: "Firebase", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-[#FFCA28]"><title>Firebase</title><path d="M3.684 19.45a.34.34 0 0 1-.168-.046.335.335 0 0 1-.164-.316L4.408 8.23 3.5 8.5v-2l10.832-6.5h.336l-3.328 17.528a.339.339 0 0 1-.32.28.328.328 0 0 1-.336-.312l.6-3.152-7.42 5.004a.332.332 0 0 1-.184.052zm15.808-11.3L9.16 2.096l-1.852 3.1L14.5 3.5l5 5zm-3.328-3.048L18 3.5l-3.5 3.5-1.5-1.5z"/></svg>, description: "La solución BaaS para acelerar el desarrollo. La uso para autenticación, bases de datos en tiempo real y hosting." },
  { name: "Docker", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-[#2496ED]"><title>Docker</title><path d="M22.46 12.35c0-1.66-1.24-3-3-3h-.5c-.88 0-1.7.4-2.26 1.13-.56-.73-1.38-1.13-2.26-1.13s-1.7.4-2.26 1.13C11.62 9.75 10.8 9.35 10 9.35h-.5c-1.76 0-3 1.34-3 3 0 .7.24 1.35.63 1.88-.5.4-1.13 1-1.13 2.12 0 1.33 1.1 2.5 2.5 2.5h10c1.4 0 2.5-1.17 2.5-2.5 0-1.12-.63-1.72-1.13-2.12.4-.53.63-1.18.63-1.88zM8.5 13.85H6v-1.5h2.5zm0-3H6v-1.5h2.5zm4 3H10v-1.5h2.5zm0-3H10v-1.5h2.5zm4 3h-2.5v-1.5H16.5zm0-3h-2.5v-1.5H16.5z"/></svg>, description: "Fundamental en mi flujo de trabajo para crear entornos de desarrollo consistentes y desplegar aplicaciones en contenedores." },
  ...
  { name: "GitHub/GitLab", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-white"><title>GitHub</title><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12"/></svg>, description: "Plataformas clave para alojar repositorios, colaborar y automatizar flujos de trabajo con Actions y Pipelines." },
  ...
  { name: "Linux", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-white"><title>Linux</title><path d="M5.62 13.11c-.37 0-.58.3-.58.82v1.73c0 .52.21.82.58.82.38 0 .59-.3.59-.82v-1.73c0-.52-.21-.82-.59-.82zm-3.3 0c-.38 0-.59.3-.59.82v1.73c0 .52.21.82.59.82.37 0 .58-.3.58-.82v-1.73c0-.52-.21-.82-.58-.82zm14.63.15c-.4 0-.6.2-.6.7v3.29c0 .5.2.7.6.7s.6-.2.6-.7v-3.29c0-.5-.2-.7-.6-.7zM12 0C5.37 0 0 5.37 0 12s5.37 12 12 12 12-5.37 12-12S18.63 0 12 0zm5.18 17.6c-.34.3-.78.47-1.32.47-.9 0-1.5-.4-1.92-1.12l-2.3 4.38c-.34.64-.8.97-1.4.97-.4 0-.7-.1-1-.32l8.3-8.3zm-10.36-1.5c.34-.3.78-.47 1.32-.47.9 0 1.5.4 1.92 1.12l2.3-4.38c.34-.64.8-.97 1.4-.97.4 0 .7.1 1 .32l-8.24 8.24c.02-.12.04-.23.04-.34v-3.52z"/></svg>, description: "El sistema operativo de servidor por excelencia. Domino la línea de comandos para administrar sistemas y redes." },
  { name: "Vercel", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-white"><title>Vercel</title><path d="M12 24L24 4H0L12 24z" /></svg>, description: "La mejor plataforma para desplegar aplicaciones front-end. Su integración con Next.js, rendimiento y DX son inigualables." },
  { name: "Kubernetes", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-[#326CE5]"><title>Kubernetes</title><path d="M12 .012a11.89 11.89 0 0 0-1.897.192l-8.465 2.82A1.986 1.986 0 0 0 .193 4.904L2.83 12 .192 19.096a1.986 1.986 0 0 0 1.445 1.88l8.465 2.82A11.89 11.89 0 0 0 12 23.988a11.89 11.89 0 0 0 1.897-.192l8.465-2.82a1.986 1.986 0 0 0 1.445-1.88L21.17 12l2.639-7.096a1.986 1.986 0 0 0-1.445-1.88l-8.465-2.82A11.89 11.89 0 0 0 12 .012zm-.948 4.23L4.415 6.09l-1.58 4.225h5.42zm1.896 0v15.51a9.904 9.904 0 0 1 0-15.51zm.948-1.74l6.637-2.212 1.58 4.225h-5.42zM4.415 17.91l6.637 1.848v-7.39H2.835zm8.483 1.848l6.637-1.848 1.58-4.225h-5.42z" /></svg>, description: "El estándar para la orquestación de contenedores. Lo uso para gestionar aplicaciones complejas y de alta disponibilidad." },
  { name: "OpenShift", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-[#EE0000]"><title>OpenShift</title><path d="M12.022 2.001A9.993 9.993 0 002.022 12a9.993 9.993 0 0010.002 9.999A9.993 9.993 0 0022.021 12 9.993 9.993 0 0012.022 2.001zm0 2.856a7.137 7.137 0 017.137 7.142 7.137 7.137 0 01-7.137 7.142 7.137 7.137 0 01-7.14-7.142 7.137 7.137 0 017.14-7.142zm5.427 3.25L12.023 15.65 6.598 8.107l1.01-1.01 4.415 4.41 4.41-4.41z" /></svg>, description: "Mi elección para entornos empresariales que requieren una plataforma de Kubernetes gestionada y con herramientas de desarrollo integradas." },
  { name: "Tailwind CSS", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-[#38B2AC]"><title>Tailwind CSS</title><path d="M12 18a6 6 0 01-6-6h12a6 6 0 01-6 6zm0-12a6 6 0 016 6H6a6 6 0 016-6z" /></svg>, description: "Un framework CSS utility-first que me permite construir diseños complejos y personalizados de forma rápida y mantenible." },
  { name: "PostgreSQL", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-[#336791]"><title>PostgreSQL</title><path d="M12 24c-1.844 0-3.52-.51-4.996-1.528l.001.002C5.51 21.49 4.312 20.1 3.52 18.5h9.96c.14 0 .27-.06.37-.16.1-.1.15-.23.15-.36v-6.96c0-.13-.05-.26-.15-.36-.1-.1-.23-.16-.37-.16H3.52c-.14 0-.27.06-.37.16-.1.1-.15.23-.15.36V18.5c0 1.25-.33 2.5-.97 3.5-.64 1-1.54 1.5-2.5 1.5H0v-1.48h-.002c1.474-3.53 4.33-6.52 7.52-6.52v-2.98c-1.474-3.53-4.33-6.52-7.52-6.52V4.48h.002C1.036.95 3.892-.04 7.082-.04V10c1.475 3.53 4.33 6.52 7.52 6.52v2.98c-1.474-3.53-4.33-6.52-7.52-6.52v1.98c3.192 0 6.05-.99 7.522-2.972l-.002.002C18.49 23.49 19.688 22.1 20.48 20.5H10.52c-.14 0-.27-.06-.37-.16-.1-.1-.15-.23-.15-.36v-6.96c0-.13.05-.26.15-.36.1.1.23.16.37.16h9.96c.14 0 .27.06.37.16.1.1.15.23.15.36V20.5c0 1.25.33 2.5.97 3.5.64 1 1.54 1.5 2.5 1.5H24V22.52h.002c-1.474-3.53-4.33-6.52-7.52-6.52v-2.98c1.474-3.53 4.33-6.52 7.52-6.52V8.52h-.002c-1.036 3.53-3.892 6.52-7.082 6.52V5c-1.475-3.53-4.33-6.52-7.52-6.52V3.02C8.108 3.02 10.156 2 12 2s3.892 1.02 5.373 3.02l.002-.002c1.492 1.98 2.625 4.32 2.625 7.48 0 3.16-1.133 5.5-2.625 7.48l-.002-.002C15.892 21.98 13.844 23 12 23v1z" /></svg>, description: "Mi base de datos relacional de código abierto preferida por su robustez, extensibilidad y rendimiento." }
];
