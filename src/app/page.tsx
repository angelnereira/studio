...
const skills = [
  ...
  { name: "Next.js", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-white"><title>Next.js</title><path d="M12 0A12 12 0 1 0 12 24A12 12 0 1 0 12 0zM8.22 19.34V6.66h2.14v10.6l6.8-10.6h2.26L11.52 17.34v2z" /></svg> },
  ...
  { name: "Vercel", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-white"><title>Vercel</title><path d="M12 24L24 4H0L12 24z" /></svg> },
  ...
  { name: "Tailwind CSS", icon: <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="text-[#38B2AC]"><title>Tailwind CSS</title><path d="M12 18a6 6 0 01-6-6h12a6 6 0 01-6 6zm0-12a6 6 0 016 6H6a6 6 0 016-6z" /></svg> },
