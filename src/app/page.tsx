...
const skills = [
  { name: "Python", icon: <PythonIcon className="text-[#3776AB]" />, description: "Mi lenguaje preferido para backend, ciencia de datos e IA por su versatilidad y ecosistema robusto." },
  { name: "TypeScript", icon: <TypescriptIcon className="text-[#007ACC]" />, description: "Esencial para construir aplicaciones front-end y back-end a gran escala, garantizando código mantenible y libre de errores." },
