...
const projects = [
  ...
  },
  {
    ...
    description: "Plataforma integral de gestión de viajes desplegada en infraestructura cloud híbrida (Google Cloud + Oracle Cloud) con integración de bases de datos enterprise.",
    ...
    solution: "Sistema empresarial completo desplegado en arquitectura cloud híbrida con Google Cloud Platform y Oracle Cloud Infrastructure, integrando Oracle Database para garantizar robustez y escalabilidad enterprise.",
    features: [
      ...
      "Compute Escalable con auto-scaling",
      "Integración entre plataformas cloud",
