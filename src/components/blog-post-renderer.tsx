  ...
  if (post.slug === 'analisis-musical-panama') {
    return (
        <>
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none mx-auto my-8">
                <p>
                    Los datos presentados provienen de fuentes verificadas incluyendo Spotify Charts, YouTube Analytics,
                    Billboard, Forbes, y análisis de mercado de IFPI y Statista.
                </p>
            </div>
        </>
    );
