...
export const translations: Record<Language, Record<string, string>> = {
    es: {
        ...
        'hero.badge': 'Creador de Sago One · ERP SaaS',
        ...
        'about.current.text': 'Actualmente lidero el desarrollo de Sago One (ERP SaaS Enterprise) y Plenty Market (E-commerce PWA). Ambos sistemas manejan datos críticos con encriptación AES-256 y esquemas multi-tenant avanzados.',
        ...
        'project.sago_one.label': 'ERP SaaS Todo-en-Uno | POS & FinTech | Next.js 15',
        'project.sago_one.subtitle': 'Plataforma Enterprise ERP y Facturación Electrónica',
        'project.sago_one.description': 'Plataforma Enterprise Todo-en-Uno para negocios en Panamá. Comenzando como un sistema PWA de facturación electrónica certificada por la DGI, ahora integra Inventario Pro en tiempo real, un Punto de Venta (POS) táctil ágil y gestión de Nómina Legal. Su arquitectura offline-first garantiza operatividad ininterrumpida en zonas con baja conectividad.',
        ...
        'project.sago_one.highlight.security.desc': 'Encriptación AES-256 para credenciales PAC/DGI, autenticación robusta y manejo seguro de datos fiscales.',
        'project.sago_one.highlight.database.title': 'Ecosistema Modular (ERP)',
        'project.sago_one.highlight.database.desc': 'Integración fluida entre Facturación v2.0, Punto de Venta (POS) rápido, gestión de inventario con tracking y planillas legales.',
    ...
    en: {
        ...
        'hero.badge': 'Creator of Sago One · ERP SaaS',
        ...
        'about.current.text': 'Currently leading the development of Sago One (Enterprise ERP SaaS) and Plenty Market (E-commerce PWA). Both systems handle critical data with AES-256 encryption and advanced multi-tenant schemas.',
        ...
        // Project Details
        'project.sago_one.title': 'Sago One',
        'project.sago_one.label': 'All-in-One ERP SaaS | POS & FinTech | Next.js 15',
        'project.sago_one.subtitle': 'Enterprise ERP and Electronic Invoicing Platform',
        'project.sago_one.description': 'All-in-One Enterprise Platform for businesses in Panama. Starting as a DGI-certified electronic invoicing PWA, it now integrates real-time Pro Inventory, an agile touch Point of Sale (POS), and Legal Payroll management. Its offline-first architecture ensures uninterrupted operation in low-connectivity areas.',
        ...
        'project.sago_one.highlight.database.title': 'Modular Ecosystem (ERP)',
        'project.sago_one.highlight.database.desc': 'Seamless integration between Invoicing v2.0, fast Point of Sale (POS), inventory management with tracking, and legal payroll.',
