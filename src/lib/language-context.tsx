...
const translations: Record<Language, Record<string, string>> = {
    es: {
        ...
        'hero.description': 'Especialista en sistemas Next.js y aplicaciones que funcionan sin internet (Offline-First). Creo soluciones SaaS rápidas, seguras y escalables como Sago One.',
    ...
    en: {
        ...
        'hero.description': 'Specialist in Next.js systems and applications that work offline (Offline-First). I build fast, secure, and scalable SaaS solutions like Sago One.',
